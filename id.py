...
def get_check(code):
    i = (int(code[0:1]) * 7 + int(code[1:2]) * 9 + int(code[2:3]) * 10 + int(code[3:4]) * 5 + int(code[4:5]) * 8 +
         int(code[5:6]) * 4 + int(code[6:7]) * 2 + int(code[7:8]) * 1 + int(code[8:9]) * 6 + int(code[9:10]) * 3 +
         int(code[10:11]) * 7 + int(code[11:12]) * 9 + int(code[12:13]) * 10 + int(code[13:14]) * 5 +
         int(code[14:15]) * 8 + int(code[15:16]) * 4 + int(code[16:17]) * 2) % 11
    if i == 0:
        return "1"
    elif i == 1:
        return "0"
...
tel = ["130", "131", "132", "133", "134", "135", "136", "137", "138", "139",
...
def get_id():
    code = choice(location) + choice(year) + choice(month) + choice(day) + choice(cod) + choice(cod) + choice(cod)
    return code + get_check(code)


def get_tel():
    return str(choice(tel)) + str(choice(cod)) + str(choice(cod)) + str(choice(cod)) + str(choice(cod)) + str(choice(cod)) + str(choice(cod)) + str(choice(cod)) + str(choice(cod))


def get_ip():
    return str(random.randint(10, 254)) + "." + str(random.randint(10, 254)) + \
           "." + str(random.randint(10, 254)) + "." + str(random.randint(10, 254))
