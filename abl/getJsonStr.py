...
str9 = ''
stra = ''
db = pymysql.connect(host="localhost", user="root", password="root", database="abl")
                                                            ...
                                                            if cursor8.rowcount == 0:
                                                                ...
                                                                for d9 in data8:
                                                                    ...
                                                                    if cursor9.rowcount == 0:
                                                                        ...
                                                                        for da in data9:
                                                                            cursora = db.cursor()
                                                                            cursora.execute("SELECT _id, superior, showname, istype FROM abl WHERE superior='" + str(da[0]) + "'")
